...
const children = [
  ...
  h1("Data Overview"),
  p("Events are dominated by Squamata (220 events, 126 species) and Anura (195 events, 145 species), together 95.2% of events, with smaller contributions from Caudata (17 events) and Testudines (3 events); no provincial events involve Crocodylia or Gymnophiona (Table 1). Newly recorded species represent 22.0% (Anura), 12.3% (Caudata), 18.6% (Squamata) and 6.2% (Testudines) of the corresponding Chinese species pools, indicating that even the best-surveyed groups continue to yield distributional novelty. Spatially, events concentrate in the southwestern and southern mountain systems — Yunnan (60), Guizhou (42), Guangxi (40), Guangdong (37), Hubei and Hunan (26 each) — consistent with high herpetofaunal richness, karst and montane habitat complexity, and intensified recent survey effort (Figures 1 and 2). Temporally, events rise steeply after 2010 (73.4% of events published since 2010), mirroring the expansion of provincial surveys, molecular identification and integrative taxonomy (Figure 3). Among assessed events, 23.3% involve species listed as threatened (VU, EN or CR) on China's Biodiversity Red List, 36 events involve nationally protected species (4 Class I, 32 Class II), and 157 events (113 amphibian, 44 reptile rows resolved to 100 species) involve Chinese endemics — so a substantial fraction of distributional novelty concerns exactly the taxa of highest conservation concern."),
